package videomeeting.capture.sdk
...
import videomeeting.capture.common.AppSettings
import videomeeting.capture.core.CaptureManager
import videomeeting.capture.core.CaptureManager.MediaSettings
import videomeeting.capture.protocol.Messages
import org.slf4j.LoggerFactory
import videomeeting.capture.core.CaptureManager.{Command, MediaSettings}
...
object MediaCapture {
  ...
  import videomeeting.capture.common.AppSettings._
...
class MediaCapture(
  ...
  private var captureManager: Option[ ActorRef[Command]] = None
