...
//import videomeeting.protocol.ptcl.processer2Manager.ProcessorProtocol
//import videomeeting.protocol.ptcl.processer2Manager.ProcessorProtocol.{RecordData, RecordInfoRsp, RecordList}
import videomeeting.protocol.ptcl.distributor2Manager.DistributorProtocol.{CheckStreamReq, CheckStreamRsp, FinishPullReq, RecordInfoRsp, SeekRecord, StartPullReq, StartPullRsp}
import videomeeting.roomManager.common.AppSettings.{distributorDomain, distributorIp, distributorPort, distributorUseIp}
import videomeeting.roomManager.http.ServiceUtils.CommonRsp
import videomeeting.roomManager.utils.ProcessorClient.{log, postJsonRequestSend}
