package videomeeting.player.protocol

import akka.actor.typed.ActorRef
import javafx.scene.canvas.GraphicsContext
import javafx.scene.image.Image
import videomeeting.player.core.ImageActor.ImageCmd
import videomeeting.player.core.PlayerGrabber
import videomeeting.player.core.PlayerManager.{MediaInfo, MediaSettings}
import videomeeting.player.core.SoundActor.SoundCmd
import videomeeting.player.core.PlayerGrabber.MonitorCmd
...
object Messages {
  ...
  //播放grabber初始化成功
  final case class GrabberInitialed(playerGrabber: ActorRef[MonitorCmd], mediaInfo: MediaInfo, mediaSettings: MediaSettings, gc: Option[GraphicsContext] = None) extends RTCommand
