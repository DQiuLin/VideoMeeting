...
import videomeeting.processor.common.AppSettings.{debugPath, isDebug, isTest}
import videomeeting.protocol.ptcl.processer2Manager.Processor
...
object RoomManager {
  ...
  case class NewConnection(roomId: Long, host: String, client: List[String], pushLiveId: String, pushLiveCode: String, startTime:Long) extends Command
