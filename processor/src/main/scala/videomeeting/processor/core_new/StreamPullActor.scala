...
import videomeeting.processor.Boot.{blockingDispatcher, roomManager}
import videomeeting.processor.common.AppSettings.{debugPath, isDebug, rtpServerDst, rtpToHost}
import videomeeting.processor.core_new.RoomManager.CloseRoom
import videomeeting.processor.core_new.StreamPullPipe.{ClosePipe, NewBuffer}
import videomeeting.rtpClient.Protocol.{Command, NoStream, PullStreamData, PullStreamPacketLoss, PullStreamReqSuccess, StreamStop}
import videomeeting.rtpClient.PullStreamClient
    ...
    Behaviors.setup[Command] { ctx =>
      ...
      Behaviors.withTimers[Command] {
        implicit timer =>
          ...
          val pullStreamDst = new InetSocketAddress(rtpToHost, 42020)
          val host = "0.0.0.0"
