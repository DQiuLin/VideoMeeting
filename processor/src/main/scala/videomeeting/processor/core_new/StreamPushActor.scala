...
import videomeeting.processor.common.AppSettings.{distributorHost, rtpServerDst, rtpToHost}
import videomeeting.rtpClient.Protocol.{AuthRsp, Command, PushStreamError}
import videomeeting.rtpClient.PushStreamClient
    ...
    Behaviors.setup[Command] { ctx =>
      ...
      Behaviors.withTimers[Command] {
        implicit timer =>
          ...
          val pushStreamDst = new InetSocketAddress(rtpToHost, 42021)
          val host = "0.0.0.0"
