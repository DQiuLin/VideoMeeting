...
object Hls2Mp4 {
  ...
  def testFlvSize(): Unit = {
    ...
    val pb = new ProcessBuilder(ffmpeg, "-i", "udp://127.0.0.1:41100", "-f",
      "dash", "-hls_playlist", "1", "/Users/angel/Downloads/c94.mkv",
      "/Users/angel/Downloads/dash/record.ts")
  ...
  def hlsMulti():Unit = {
    val ffmpeg = Loader.load(classOf[org.bytedeco.ffmpeg.ffmpeg])
    val pb = new ProcessBuilder(ffmpeg,"-i","/Users/angel/Downloads/dash/video.mp4",
      ...
      "/Users/angel/Downloads/dash/test.m3u8")
    val pro = pb.inheritIO().start()
    Thread.sleep(100000)
  }
