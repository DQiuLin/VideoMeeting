package org.seekloud.theia.rtpServer.utils

import org.seekloud.theia.rtpServer.common.AppSettings
import org.seekloud.theia.rtpServer.protocol.RoomManagerProtocol._
...
object RoomManagerClient extends HttpUtil with CirceSupport{
  ...
  private val log = LoggerFactory.getLogger("org.seekloud.theia.rtpServer.utils.RoomManagerClient")
