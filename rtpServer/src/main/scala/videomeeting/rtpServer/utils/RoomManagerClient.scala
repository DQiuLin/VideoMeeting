package videomeeting.rtpServer.utils

import videomeeting.rtpServer.common.AppSettings
import videomeeting.rtpServer.protocol.RoomManagerProtocol._
...
object RoomManagerClient extends HttpUtil with CirceSupport{
  ...
  private val log = LoggerFactory.getLogger("videomeeting.rtpServer.utils.RoomManagerClient")
